...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">select-icon documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/MatSelectIconModule.html" data-type="entity-link">MatSelectIconModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-MatSelectIconModule-8f7d5cd91b1820335f709777e8cc629e"' : 'data-target="#xs-components-links-module-MatSelectIconModule-8f7d5cd91b1820335f709777e8cc629e"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-MatSelectIconModule-8f7d5cd91b1820335f709777e8cc629e"' :
                                            'id="xs-components-links-module-MatSelectIconModule-8f7d5cd91b1820335f709777e8cc629e"' }>
                                            <li class="link">
                                                <a href="components/MatSelectIconComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">MatSelectIconComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/MatSelectIcon.html" data-type="entity-link">MatSelectIcon</a>
                            </li>
                            <li class="link">
